...
def build_parser():
  ...
  # optional arguments
  parser.add_argument("--content_weight", type=float, default=0.00125, required=False, help="Content Weight")
  parser.add_argument("--style_weight", type=float, default=1.0, required=False, help="Style Weight")
  parser.add_argument("--iter", type=int, default=100, required=False, help="Number of Iteration")
  return parser
